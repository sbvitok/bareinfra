...
import (
	...
	"github.com/virtual-kubelet/bareinfra/cmd/virtual-kubelet/commands/providers"
	"github.com/virtual-kubelet/bareinfra/cmd/virtual-kubelet/commands/root"
	"github.com/virtual-kubelet/bareinfra/cmd/virtual-kubelet/commands/version"
...
var (
	buildVersion = "N/A"
	buildTime = "N/A"
	k8sVersion   = "v1.18.3" // This should follow the version of k8s.io/kubernetes we are importing
)
